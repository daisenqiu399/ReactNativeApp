...
import  Header  from '../../components/ScreenWrapper'
...
const Profile = () => {
  ...
  const getPosts = async () => {
    if (!hasMore) return null;  //if no more post then don't call the api
  ...
  const handleLogout = () => {
    Alert.alert('Confirm', 'Are you sure want log out', [
      {
        text: 'Cancel',
